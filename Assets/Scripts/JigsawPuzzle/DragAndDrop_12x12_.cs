...
public class DragAndDrop_12x12_ : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (!hit.transform.GetComponent<PieceScript_12x12_>().in_right_position)
                {
                    selected_piece = hit.transform.gameObject;
                    selected_piece.GetComponent<PieceScript_12x12_>().selected = true;
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            {
                selected_piece.GetComponent<PieceScript_12x12_>().selected = false;
                selected_piece = null;
            }
