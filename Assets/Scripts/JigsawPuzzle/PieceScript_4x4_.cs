            ...
            if (!selected)
            {
                if (in_right_position == false)
                {
                    ...
                    if (in_right_position == true)
                    {
                        ...
                        Debug.Log(completed_pieces + " out of 16(" + completed_pieces + "/16)");
                    }
