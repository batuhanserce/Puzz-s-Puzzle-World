...
public class DragAndDrop_6x6_ : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (!hit.transform.GetComponent<PieceScript_6x6_>().in_right_position)
                {
                    selected_piece = hit.transform.gameObject;
                    selected_piece.GetComponent<PieceScript_6x6_>().selected = true;
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            {
                selected_piece.GetComponent<PieceScript_6x6_>().selected = false;
                selected_piece = null;
            }
